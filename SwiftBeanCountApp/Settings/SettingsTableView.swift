        ...
        Table(
            ...
            columns: {
                ...
                TableColumn(T.value1Name, value: \.value1) {
                    if editing == $0.id {
                        TextField(T.value1Name, text: $value1).onSubmit { endEditing() }.textFieldStyle(.squareBorder)
                    } else {
                        Text($0.value1)
                    }
                }
                if T.hasValue2 {
                    TableColumn(T.value2Name, value: \.value2) {
                        if editing == $0.id {
                            TextField(T.value2Name, text: $value2).onSubmit { endEditing() }.textFieldStyle(.squareBorder)
                        } else {
                            Text($0.value2)
                        }
                    }
